...
public class TeacherAdapter extends RecyclerView.Adapter<TeacherAdapter.TeacherViewHolder> {
    ...
    public TeacherAdapter(Context context) {
        ...
        teachers.add("Aarti Ma'am-English");
        teachers.add("Tushar Sir-Eng Grammar");
        teachers.add("Pravin Sir-Marathi");
        teachers.add("Maya Ma'am-Marathi");
        teachers.add("Shashi Sir-Hindi Entire");
        teachers.add("Shashi Sir-Hindi Comp");
        teachers.add("Kanika Ma'am-French Comp");
        teachers.add("Pravin Sir-Sans Comp");
        teachers.add("Pravin Sir-Sans Entire");
        teachers.add("Sonal Ma'am-Algebra");
        teachers.add("Priti Ma'am-Algebra");
        teachers.add("Hitesh Sir-Algebra");
        teachers.add("Sonal Ma'am-Geometry");
        teachers.add("Hitesh Sir-Geometry");
        teachers.add("Shabina Ma'am-Physics");
        teachers.add("Harshil Sir-Physics");
        teachers.add("Harshil Sir-Chemistry");
        teachers.add("Ruddhi Ma'am-Biology");
        teachers.add("Mandi Sir-History/Civics");
        teachers.add("Juliet Ma'am-Geography");
    ...
    public void delete(int position) {
        if (position < teachers.size() - 1) {
            teachers.remove(position);
            notifyDataSetChanged();
        } else {
            teachers.remove(position);
            new AlertDialog.Builder(context)
                    .setTitle("Form finished")
                    .setMessage("The form is submitted.\nThanks for the views,your opinion and satisfaction is our top priority" +
                            "\nREMARK::\nKindly click on the three dots in the rightmost corner to logout.")
                    .setPositiveButton("GOTO the Screen", null)
                    .show();
            notifyDataSetChanged();
        }
    }
    ...
    public class TeacherViewHolder extends RecyclerView.ViewHolder {
        ...
        public TeacherViewHolder(final View itemView) {
            super(itemView);
            mref = new Firebase("https://tscore-cc104.firebaseio.com/teacher_feedback/");
                        ...
                        new AlertDialog.Builder(view.getContext())
                                ...
                                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        ...
                                        Toast.makeText(itemView.getContext(), "Data Submitted", Toast.LENGTH_LONG).show();
                                        b01.setBackgroundResource(R.color.standardwhite);
                                        b02.setBackgroundResource(R.color.standardwhite);
                                        b03.setBackgroundResource(R.color.standardwhite);
                                        b04.setBackgroundResource(R.color.standardwhite);
                                        ...
                                        mref.child(prefManager.getMobileNumber()).push().setValue(object);
            ...
            finalsubmit.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(check) {
                        ...
                        submit.setBackgroundResource(R.color.standardwhite);
                        check = false;
                    }
                    else{
                        new AlertDialog.Builder(v.getContext())
                                .setTitle("ALERT")
                                .setMessage("Please fill the choices first and send it to database and only then you " +
                                        "can submit it finally")
